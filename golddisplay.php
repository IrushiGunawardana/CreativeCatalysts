...
<html>
<head>
<title>Gold Package Order</title>
...
<div class= "tabledata">
        ...
        <center>
        <img src = "images/gold.png" width="200" height="200" alt="platinum"></div>
        <h1 class="gold">Gold Package -$1000</h1>
      </center>
...
<?php
$query = mysqli_query($conn,"select*FROM  goldorderdetails");
...
?>
  ...
  <td><?php echo $row ['id']; ?></td> 
   ...
   <td>
        ...
        <button class="btn1"><a href="deletegold.php?deleteid=<?php echo $row['id']; ?>" class="hi">Delete Order</a></button>
