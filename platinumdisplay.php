...
<div class= "tabledata">
        ...
        <center>
        <img src = "images/platinum.png" width="200" height="200" alt="platinum"></div>
        <h1 class="platinum1">Platinum Package -$1500</h1>
      </center>
...
<?php
$query = mysqli_query($conn,"select*FROM platinumorderdetails");
...
?>
  ...
  <td><?php echo $row ['id']; ?></td> 
   ...
   <td><?php echo $row['dudedate']; ?></td>
   <td>
        <button class="btn1"><a href="platorderupdate.php?updateid=<?php echo $row['id'];?>" class="hi">Edit Order</a></button>
        <button class="btn1"><a href="deleteplat.php?deleteid=<?php echo $row['id']; ?>" class="hi">Delete Order</a></button>
...
<center>
  ...
  <br>
  <button class="btn2"><a href="indexxx.html"class="edit">Proceed To CheckOut</a></button>
  <br>
